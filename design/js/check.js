window.addEventListener('load', () => {
  ...
  document.getElementById('amountSend-exp').innerHTML = `${new Intl.NumberFormat().format(sessAmountExp)}`
  ...
  document.getElementById('amountReceive-benef').innerHTML = `${sessAmountBenef}`
})
